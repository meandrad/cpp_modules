...
/*   Updated: 2026/04/08 19:33:57 by meandrad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	testAbstractClass(void)
{
	separator("Abstract Class Verification");
	std::cout << "✓ Animal is abstract - cannot instantiate directly" << std::endl;
	std::cout << "✓ Can only create through derived classes (Dog, Cat)" << std::endl;
	std::cout << "✓ Polymorphic behavior through base class pointers works" << std::endl;
